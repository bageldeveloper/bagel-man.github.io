...
function updatePage(file) {
  ...
  html = html.replace(
    ...
    `$1${eol}${slotMarkup("rectangle game-ad--rectangle-left", "Advertisement left of game").replace(">", ' data-ad-rail-position="1">')}${eol}${slotMarkup("rectangle game-ad--rectangle-right", "Advertisement right of game").replace(">", ' data-ad-rail-position="1">')}$2`
  );
  html = html.replace(
